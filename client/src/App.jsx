...
//   useEffect(() => {
//     fetch("http://localhost:5000/api/income-categories")
//       .then((res) => res.json())
//       .then((data) => {
//         setIncomeCat([...data]);
//         console.log(data);
...
//   useEffect(() => {
//     console.log("Income categories updated:", incomeCat);
//   }, [incomeCat]);
...
//         <Route path="input/:mode?" element={<Input incomeCat={incomeCat} expenseCat={expenseCat} />} />
